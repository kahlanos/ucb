                                    ...
                                    <div x-data="
                                                    {
                                                        rating: 0,
                                                        hoverRating: 0,
                                                        ratings: [{'amount': 1, 'label':'Horrible'}, {'amount': 2, 'label':'Mala'}, {'amount': 3, 'label':'Buena'},
                                                            {'amount': 4, 'label':'Muy Buena'}, {'amount': 5, 'label':'Cojonuda'}],
                                                        rate(amount) {
                                        ...
                                        <div class="flex space-x-0 bg-gray-100">
                                            <template x-for="(star, index) in ratings" :key="index">
                                                <button @click="rate(star.amount)" @mouseover="hoverRating = star.amount" @mouseleave="hoverRating = rating" aria-hidden="true" :title="star.label" 
                                                    class="rounded-sm text-gray-400 fill-current focus:outline-none focus:shadow-outline p-1 w-12 m-0 cursor-pointer" 
                                                    :class="{'text-gray-600': hoverRating >= star.amount, 'text-purple-600': rating >= star.amount && hoverRating >= star.amount}">
